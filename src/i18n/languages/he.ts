...
export const he: Translation = {
    ...
    [Key.untitled]: "ללא כותרת",
    [Key.uncategorized]: "ללא קטגוריה",
    [Key.noTags]: "ללא תגיות",

    [Key.wordCount]: "מילה",
    [Key.wordsCount]: "מילים",
    [Key.minuteCount]: "דקה",
    [Key.minutesCount]: "דקות",
    [Key.postCount]: "פוסט",
    [Key.postsCount]: "פוסטים",

    [Key.themeColor]: "צבע ערכת נושא",

    [Key.lightMode]: "בהיר",
    [Key.darkMode]: "כהה",
    [Key.systemMode]: "מערכת",

    [Key.more]: "עוד",

    [Key.author]: "מחבר",
    [Key.publishedAt]: "פורסם ב-",
    [Key.license]: "רישיון",
    [Key.colorFire]: "אדמדם",
    [Key.colorOcean]: "תכלת",
    [Key.colorLavender]: "אינדיגו",
    [Key.colorMagenta]: "סגול",
    [Key.colorRose]: "ורוד",
    [Key.blog]: "בלוג",
    [Key.tagFriend]: "חבר",
    [Key.tagSchoolmate]: "חבר ללימודים",
    [Key.tagTeacher]: "מורה",
    [Key.tagLover]: "בן/בת זוג",
    [Key.tagFamily]: "משפחה",
    [Key.tagSelf]: "עצמי",
    [Key.tagFrontend]: "צד לקוח",
    [Key.tagBackend]: "צד שרת",
    [Key.tagReact]: "React",
    [Key.fallbackToMainLang]: 'למאמר זה אין תרגום בשפה הנוכחית. מוצג בשפה הראשית.',
