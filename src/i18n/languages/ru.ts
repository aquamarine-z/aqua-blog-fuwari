...
export const ru: Translation = {
    ...
    [Key.colorFire]: "Малиновый",
    [Key.colorOcean]: "Аква",
    [Key.colorLavender]: "Индиго",
    [Key.colorMagenta]: "Фиолетовый",
    [Key.colorRose]: "Розовый",
    [Key.blog]: "Блог",
    [Key.tagFriend]: "Друг",
    [Key.tagSchoolmate]: "Одноклассник",
    [Key.tagTeacher]: "Учитель",
    [Key.tagLover]: "Пара",
    [Key.tagFamily]: "Семья",
    [Key.tagSelf]: "Я",
    [Key.tagFrontend]: "Фронтенд",
    [Key.tagBackend]: "Бэкенд",
    [Key.tagReact]: "React",
    [Key.fallbackToMainLang]: 'Эта статья не переведена на текущий язык. Показывается на основном языке.',
